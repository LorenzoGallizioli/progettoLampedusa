...
## Formula 4:
 # - Abbiamo trovato questa formula importante perchè cresce all'aumentare dei rimbalzi ottenuti e diminuisce all'aumentare dei rimbalzi subiti, considerando anche un coefficiente che da particolare importanza alla difesa

## Formula 5:
 # - Abbiamo trovato questa formula importante perchè ci mostra quanto sono influenti i rimbalzi nel rapporto tra le palle perse dalla squadra e le palle perse dagli avversari
...
hist(df$reb, col = 'steelblue', prob = TRUE)
lines(density(df$reb), col = "red")
lines(density(normal), col = "green")
