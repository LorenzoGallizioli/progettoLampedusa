...
#---------------------------------------------------------------------
#DA AGGIUNGERE
#Nel plot in pratica i grafici risultano idonei ai tutti i test e le analisi che abbiamo fatto, poi quando gli abbelliamo risultano più brutti
#---------------------------------------------------------------------
...
# Funzione per creare il plot di Residuals vs Fitted (Residui vs. Valori Previsti)
res_vs_fitted_plot <- ggplot(linMod, aes(.fitted, .resid)) +
  geom_point(color = "skyblue", alpha = 0.7, size = 3) +
  geom_smooth(se = FALSE, color = "red", method = "loess", size = 1) +
  labs(title = "Residuals vs Fitted", x = "Fitted Values", y = "Residuals") +
  theme_minimal() +
...
# Converti il plot in un oggetto plotly
res_vs_fitted_plotly <- ggplotly(res_vs_fitted_plot)

# Funzione per creare il plot QQ dei Residui
qq_plot_plot <- ggplot(linMod, aes(sample = .stdresid)) +
  stat_qq(color = "skyblue", size = 2) +
  stat_qq_line(color = "red", size = 1) +
  labs(title = "QQ Plot dei Residui", x = "Quantiles teorici", y = "Quantiles osservati") +
  theme_minimal() +
...
# Converti il plot in un oggetto plotly
qq_plot_plotly <- ggplotly(qq_plot_plot)
...
# Converti il plot in un oggetto plotly
scale_location_plot_plotly <- ggplotly(scale_location_plot)

# Funzione per creare il plot Residuals vs Leverage (Residui vs. Leverage)
res_vs_leverage_plot <- ggplot(linMod, aes(.hat, .stdresid)) +
  geom_point(color = "skyblue", alpha = 0.7, size = 3) +
  geom_smooth(se = FALSE, color = "red", method = "loess", size = 1) +
  labs(title = "Residuals vs Leverage", x = "Leverage", y = "Standardized Residuals") +
  theme_minimal() +
...
# Converti il plot in un oggetto plotly
res_vs_leverage_plotly <- ggplotly(res_vs_leverage_plot)

# Visualizza i quattro plot interattivi
subplot(
  res_vs_fitted_plotly, 
  qq_plot_plotly, 
  scale_location_plot_plotly, 
  res_vs_leverage_plotly, 
  nrows = 2, 
  margin = 0.05
)
...
# Funzione per creare il plot di Residuals vs Fitted (Residui vs. Valori Previsti)
res_vs_fitted_plot <- ggplot(linModNormalized, aes(.fitted, .resid)) +
  geom_point(color = "skyblue", alpha = 0.7, size = 3) +
  geom_smooth(se = FALSE, color = "red", method = "loess", size = 1) +
  labs(title = "Residuals vs Fitted", x = "Fitted Values", y = "Residuals") +
  theme_minimal() +
...
# Funzione per creare il plot QQ dei Residui
qq_plot_plot <- ggplot(linModNormalized, aes(sample = .stdresid)) +
  stat_qq(color = "skyblue", size = 2) +
  stat_qq_line(color = "red", size = 1) +
  labs(title = "QQ Plot dei Residui", x = "Quantiles teorici", y = "Quantiles osservati") +
  theme_minimal() +
...
# Funzione per creare il plot Residuals vs Leverage (Residui vs. Leverage)
res_vs_leverage_plot <- ggplot(linModNormalized, aes(.hat, .stdresid)) +
  geom_point(color = "skyblue", alpha = 0.7, size = 3) +
  geom_smooth(se = FALSE, color = "red", method = "loess", size = 1) +
  labs(title = "Residuals vs Leverage", x = "Leverage", y = "Standardized Residuals") +
  theme_minimal() +
