...
```{r Rimozione outliers, echo=FALSE, message=FALSE, warning=FALSE}
...
Summary prima di rimuovere outliers
...
Summary dopo aver rimosso outliers con grafico
```{r, echo=FALSE, message=FALSE, warning=FALSE}
...
Nel complesso entrambi i modelli sembrano essere buoni, spiegano entrambi circa l'84% della varianza nella variabile dipendente "won", anche se la rimozione degli outliers ha migliorato leggermente i risultati.

Dato che la differenza tra i due modelli e' molto ridotta (<0.5%), tale da essere trascurabile, abbiamo deciso di utilizzare il modello comprendente gli outliers
