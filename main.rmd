...
Possiamo valutare la bonta dei due modelli mediante il valore di AIC (gia visto sopra).
...
```
Pertanto, il modello lineare (aic_2) sembra essere migliore rispetto al modello di Poisson (aic_2_pois), poiché ha un valore AIC inferiore. La differenza tra i due valori AIC può essere ulteriormente considerata per valutare quanto il modello lineare sia significativamente migliore rispetto al modello di Poisson.
...
Infine, il confronto dei modelli è stato esteso all'analisi della differenza tra un modello lineare e un modello di Poisson attraverso il criterio di informazione di Akaike (AIC). I risultati dell'AIC hanno indicato che il modello lineare (aic_2) è preferibile al modello di Poisson (aic_2_pois), suggerendo che il primo si adatti meglio alla variabilità delle vittorie in relazione ai rimbalzi.
